  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tight">Support Requests</h2>
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Find a peer to assist</p>
        </div>
      ...
      {availableTasks.length === 0 ? (
        <div className="py-20 bg-white rounded-[3rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center text-center p-8">
           <i className="fas fa-hand-holding-heart text-4xl text-slate-100 mb-4"></i>
           <p className="text-slate-800 font-black text-lg">No requests yet</p>
           <p className="text-slate-400 text-xs font-medium">Everyone seems caught up for now!</p>
        </div>
      ) : (
